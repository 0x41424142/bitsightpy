...
CALL_SCHEMA = frozendict(
    {
        ...
        "portfolio": {
            ...
            "portfolio_api_filters": {
                ...
                "params": ["exclude_alerts_only", "fields", "folder", "format", "quarters_back", "rating_date", "show_event_evidence", "show_ips", "tier"],
                "post_data": {},
                "use_requests_json_for_post": False,
                "method": ["GET"],
                "pagination": False,
            ...
            "get_service_provider_products": {
                ...
                "params": ["fields", "limit", "offset", "q", "sort", "guid", "relationship_type"],
                "post_data": {},
                "use_requests_json_for_post": False,
                "method": ["GET"],
                "pagination": True,
